<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true"
    CodeBehind="PreExamV2_SecureQuestionPaperUpload_Revised__1.aspx.cs" Inherits="SRPD.PreExamination.PreExamV2_SecureQuestionPaperUpload_Revised__1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Validate(obj) {
            ...
            var message = document.getElementById('<%=txtQPMsg.ClientID%>').value; ;

            var message1 = '';

            if (subject == "") {
                message1 += "<li> Please Enter Email Subject.</li><br>";
            }
            if (message == "") {
                message1 += "<li> Please Enter Email Message.</li><br>";
            }
            debugger;
            if (tbl.getElementsByTagName('input')[1].value == "")
                message1 += "<li> Please enter correct file path.</li><br>";

            if (tbl.getElementsByTagName('input')[0].value == "")
                message1 += "<li> Please enter Question papers setter name.</li><br>";
        ...
        <table cellspacing="0" cellpadding="0" width="700" border="0">
            ...
            <tr>
                <td valign="top" align="left" width="700">
                    <div id="divListPaper" runat="server">
                        <table>
                            <tr valign="top">
                                <!-- Main Content Starts-->
                                <td>
                                    <table style="width: 80%">
                                        <tr>
                                            <td style="width: 706px; height: 12px;" class="clSubHeading">
                                                <span id="mesg" runat="server">List of Papers for which slot is already created:</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 706px; height: 110px; text-align: left" align="left" valign="top">
                                                <asp:GridView ID="gvCoursePart" runat="server" AutoGenerateColumns="False" Width="700px"
                                                    ...
                                                    DataKeyNames="Course_Name,Crpr_Abbr,CrPrCh_Abbr,pk_Fac_ID,pk_Cr_ID,pk_MoLrn_ID,pk_Ptrn_ID,pk_Brn_ID,pk_CrPr_Details_ID,pk_CrPrCh_ID,fk_Record_ID,PpPpHeadCrPrChID,Published,fileUploadedCount,ExamDate,IsSlotCreated,Paper,ExamDateTime,RevisedFileUploadCnt"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="RevisedFileUploadCnt" HeaderText="Revised files upload Count" />
                                                    </Columns>
                                                </asp:GridView>
                                            </td>
                                        </tr>
                    ...
                    <div id="divPaperUpload" runat="server" style="display: none">
                        <div>
                            <table style="width: 700px; font-weight: bold">
                                <tr>
                                    <td style="text-align: right; width: 20%;">
                                        Paper Details :
                                    </td>
                                    <td style="text-align: left">
                                        <asp:Label ID="lblPaperDetails" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="text-align: right; width: 20%;">
                                    ...
                                    <td style="text-align: left">
                                        <asp:Label ID="lblPaperSchedule" runat="server"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                            <table style="width: 700px;">
                                <tr>
                                    <td align="right" colspan="2">
                                        <br />
                                        <asp:Label ID="lblMesg" runat="server" CssClass="errorNote"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <br />
                                        <b>
                                            <asp:Label ID="lblNote" runat="server" Text="Information written in below text box will reflect in e-mail along with question paper file "></asp:Label>
                                        </b>
                                        <br />
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="center">
                                        <br />
                                        <asp:TextBox ID="txtSubject" runat="server" Height="50" Width="300"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right">
                                    ...
                                    <td align="center">
                                        <br />
                                        <asp:TextBox ID="txtQPMsg" runat="server" TextMode="MultiLine" Height="100" Width="300"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div id="divImageUpload" style="border-right: #800000 solid; border-top: #800000 solid;
                            left: 350px; border-left: #800000 solid; width: 700px; border-bottom: #800000 solid;
                            top: 250px; height: 150px; background-color: white" align="center" runat="server">
