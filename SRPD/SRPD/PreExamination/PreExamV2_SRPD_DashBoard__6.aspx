<%@ Page Title="" Language="C#" MasterPageFile="~/New_Home.Master" AutoEventWireup="true"
    CodeBehind="PreExamV2_SRPD_DashBoard__6.aspx.cs" Inherits="SRPD.PreExamination.PreExamV2_SRPD_DashBoard__6" %>
    ...
    <center>
        <table style="height: 30px" cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr>
                <td style="height: 17px; width: 100%" valign="top" align="left">
                    <div id="divgvFaculty" class="well well-sm" style="font-weight: bold; height: 30px;
                        width: 100%;">
        ...
        <div class="row mb-2">
            <div class="table-wrapper col-md-12">
                <asp:GridView ID="gvFaculty" runat="server" CssClass="clGrid" OnRowDataBound="gvFaculty_RowDataBound"
                    AutoGenerateColumns="False" AllowPaging="true" PageSize="25" OnPageIndexChanging="gvFaculty_PageIndexChanging">
                    <Columns>
