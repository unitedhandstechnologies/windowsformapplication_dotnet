<%@ Control Language="c#" AutoEventWireup="True" CodeBehind="ApplicationHeader.ascx.cs" Inherits="DPTemplate2.ApplicationHeader"
...
<div id="main">
            ...
            <font face="Verdana" size="1">
                <ul>
                    ...
                    <asp:Label ID="pnlLogin" runat="server" align="right">
                        <li>
                             <span class='bul'></span>
                            <asp:HyperLink runat="server" NavigateUrl="/RegisteredStudentProfile.aspx" ID="hlkHome" meta:resourcekey="hlkHomeResource1"
                                Text="My Login"></asp:HyperLink>
                        </li>
                        <li>
                             <span class='bul'></span>
                            <asp:HyperLink runat="server" ID="hlkMySettings" meta:resourcekey="hlkMySettingsResource1"
                                Text="My Settings" NavigateUrl="/StudentSettings.aspx"></asp:HyperLink>
                        </li>
                        <li>
                             <span class='bul'></span>
    ...
    <div id='HeaderMenuHolderUni'>
       <%-- <asp:Label ID="lblTopLinks" runat="server" EnableViewState="False" meta:resourcekey="lblTopLinksResource1"></asp:Label>--%>
        ...
        <%--<span id="ctl00_UCHeader_lblTopLinks"><b><a class='TopMenus' href="<%=Classes.clsGetSettings.SitePath%>Content.aspx?ID=28169">» e-Suvidha Services</a></b><b><a class='TopMenus' href="<%=Classes.clsGetSettings.SitePath%>Content.aspx?ID=1">» Courses</a></b><b><a class='TopMenus' href="<%=Classes.clsGetSettings.SitePath%>Content.aspx?ID=2">» Colleges & Institutions</a></b><b><a class='TopMenus' href="<%=Classes.clsGetSettings.SitePath%>Content.aspx?ID=3">» Departments</a></b><b><a class='TopMenus' href="<%=Classes.clsGetSettings.SitePath%>Content.aspx?ID=4">» Pre-Admission Online Registration</a></b><b><a class='TopMenus' href="<%=Classes.clsGetSettings.SitePath%>Content.aspx?ID=5">» Scholarships</a></b><b><a class='TopMenus' href="<%=Classes.clsGetSettings.SitePath%>Content.aspx?ID=6">» Examinations</a></b><b><a class='TopMenus' href="<%=Classes.clsGetSettings.SitePath%>Content.aspx?ID=800">» Distance Education (IDOL)</a></b><b><a class='TopMenus' href="<%=Classes.clsGetSettings.SitePath%>EbscoRegisteration.aspx?ID=26392">» EBSCO</a></b></span>--%>
