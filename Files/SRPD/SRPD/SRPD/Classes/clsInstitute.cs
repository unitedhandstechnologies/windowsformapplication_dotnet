...
namespace SRPD.PreExamination
{
	...
	public class clsInstitute
	{
        ...
        public static DataTable AllInstitutes(string pk_Uni_ID,string searchCondition)
		{
			DBObjectPool Pool=null;
			DBObject oDB=null;
			try
			{
                ...
                oHs.Add("hidCondition", searchCondition);
		...
		public static DataTable AttributeInstituteDetails(string pk_Uni_ID,string pk_Inst_ID)
		{
			...
			try
			{
				...
				DataTable DT =oDB.getparamdataset("IDV2_Attribute_Institute",oHs).Tables[0]; 
				return DT;
			}
			finally
			{
